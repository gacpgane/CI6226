...
public class Indexer {
	public static final String solrUrl="http://localhost:8983/solr/IR";
	public static final String deleteData="http://localhost:8983/solr/IR/update?stream.body=<delete><query>*:*</query></delete>&commit=true";
	public static void main(String[] args) throws IOException, SolrServerException {
		//HttpSolrServer server = new HttpSolrServer("http://localhost:8983/solr/CI6226");
